...
{
  myTimers.push_back(new NewTimer("VMCUpdatePbyPGuide::Buffer", timer_level_medium));       //timer for MC, ratio etc
  myTimers.push_back(new NewTimer("VMCUpdatePbyPGuide::MovePbyP", timer_level_medium));     //timer for MC, ratio etc
  myTimers.push_back(new NewTimer("VMCUpdatePbyPGuide::Hamiltonian", timer_level_medium));  //timer for Hamiltonian
  myTimers.push_back(new NewTimer("VMCUpdatePbyPGuide::Collectables", timer_level_medium)); //timer for measurements
